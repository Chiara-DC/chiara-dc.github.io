...
export const allimages = column1.concat(column2, column3);
// For a 3-column grid, column1 = allimages.slice(0,12), column2 = allimages.slice(12, 23), column3 = allimages.slice(23, 35);
...
function filterImages(images, filter) {
  ...
  for (let i = 0; i < images.length; i++) {
    try {
      if (images[i].tags.includes(filter) === true) {
        filteredimages = [...filteredimages, images[i]];
      }
    } catch (err) {}
  }
...
export const city = filterImages(allimages, "city");
export const sunset = filterImages(allimages, "sunset");
export const cambridge = filterImages(allimages, "cambridge");
export const nature = filterImages(allimages, "nature");
export const night = filterImages(allimages, "night");
export const architecture = filterImages(allimages, "architecture");
